...
tags: ['javascript']
draft: false
summary: ' Global memory, Local memory, Scope & Variable Scope, Higher Order functions and one of the most important and powerful javascript concept it is closure.'
---
